...
public class TopEarner
{
    ...
    { 
        ...
        System.out.println("survey information regarding starting salaries for majors and generate");
        System.out.println("a report of top earners in 2014 with percentage increase from 2013.");
        System.out.println("Author: Kirk Fay\tVersion: April 20, 2017");
        ...
        try {
            ...
            System.out.println ("-----------------------------------------------"
                + "---------------------");
            for (index = numMajors - 10; index > numMajors; index++ ){
                System.out.println(careers[index].toString());
            }
